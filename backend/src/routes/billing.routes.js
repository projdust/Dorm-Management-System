...
// TODO: add a validate(billingSchema) middleware once validation schemas are written
...
// POST   /api/v1/billing          (ADMIN/STAFF only - adjust per feature's business rules)
